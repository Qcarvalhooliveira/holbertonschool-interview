<img src="https://github.com/Qcarvalhooliveira/holbertonschool-interview/blob/main/heap_sort/image/Heap%20Sort.png" width="1000" height="400" >

# **Heap Sort** :computer:

## **Description** :speech_balloon:

* The exercise involves writing a function, heap_sort, that sorts an array of integers in ascending order using the Heap sort algorithm. This function is part of a coding task where the primary goal is to demonstrate the efficiency and mechanics of the Heap sort method. Each time two elements are swapped in the array during the sorting process, the new state of the array is printed, providing a step-by-step visualization of the algorithm at work. 
